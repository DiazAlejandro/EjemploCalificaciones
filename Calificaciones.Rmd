...
grfc2.promediosemestremateria <- grfc2.promediosemestremateria+ aes(promediosemestremateria$semestre, promediosemestremateria$promedio.semestre.materia)

grfc2.promediosemestremateria <- grfc2.promediosemestremateria + geom_col() + xlab("Semestre") + ylab("Promedio Semestre") + ggtitle( "Asignaturas con el promedio mas bajo") + theme_lab()
